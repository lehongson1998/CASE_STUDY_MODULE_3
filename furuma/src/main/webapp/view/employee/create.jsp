...
<div>
    <div class="col-md-5 bg-light mt-5 p-3" style="margin: auto">
        <h3>Edit Employee</h3>
        <form action="/employee?action=insert_employee" method="post">
            <div class="mb-3 row">
            ...
            <div>
                <button class="btn btn-danger" type="button" onclick="location.href='/employee?action=list_employee'">Cancel</button>
